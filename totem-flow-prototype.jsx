...
/* ============================================================
   TOTEM FLOW — Prototipo navegable (sin backend)
   Paleta: Jordy Blue #88AFF9 · Marian Blue #2B3D8D · Negro #000
   Secundarios: Champagne Pink #DAC9BF · French Gray #BDBBBE · Platinum #DBDFE2
...
const FONT_LINK = "https://fonts.googleapis.com/css2?family=Archivo:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&display=swap";
...
export default function TotemFlowPrototype() {
  ...
  return (
    <div style={{ fontFamily: "'Archivo', sans-serif" }} className="h-screen w-full flex bg-[#F5F6F8] text-[#16181D] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-2 rounded-lg bg-[#F2F3F5] text-sm w-64 outline-none focus:ring-2"
                style={{ "--tw-ring-color": COLORS.jordy }}
              />
            </div>
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          {view === "documentos" && <PlaceholderView label="Documentos" />}
        </main>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-full flex flex-col">
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="text-xs font-semibold px-3 py-2 rounded-lg text-white" style={{ backgroundColor: COLORS.marian }}>
              Avanzar a Reunión Interna
            </button>
          </div>
        </div>
        <div className="flex items-center gap-6 text-xs text-[#6B6F76] pb-4">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {tab !== "checklist" && <PlaceholderTab label={tabs.find((t) => t.key === tab)?.label} />}
      </div>
    </div>
  );
}
...
function PlaceholderTab({ label }) {
  return (
    <div className="flex items-center justify-center h-64 text-sm text-[#9B9EA6]">
      Sección "{label}" — fuera del alcance de este prototipo visual.
    </div>
  );
}
...
function PlaceholderView({ label }) {
  return (
    <div className="flex items-center justify-center h-full text-sm text-[#9B9EA6]">
      Vista "{label}" — fuera del alcance de este prototipo visual.
    </div>
  );
}
